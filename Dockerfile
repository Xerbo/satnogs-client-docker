...
USER satnogs
RUN virtualenv -p python3 --system-site-packages . && . bin/activate && pip3 install satnogs-client==1.8 gps==3.19 --prefix=/var/lib/satnogs --prefer-binary && rm -rf .cache/pip/
